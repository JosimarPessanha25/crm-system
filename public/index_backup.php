...
/**
 * CRM System - Simple Entry Point
 * Delegates all functionality to bootstrap.php
 */
...
if (!file_exists($bootstrapFile)) {
    ...
    echo json_encode([
        ...
        'message' => 'The system bootstrap file is missing. Please check your installation.',
        'file' => $bootstrapFile,
        'timestamp' => date('c')
    ]);
    exit;
...
// Include bootstrap and let it handle everything
require_once $bootstrapFile;

// Bootstrap handles the request automatically
